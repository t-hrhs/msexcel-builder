  ...
  Workbook = (function() {
    ...
    Workbook.prototype.save = function(cb) {
      ...
      if (!fs.existsSync(target)) {
        fs.mkdirSync(target, 0755, function(e) {
      ...
      if (!fs.existsSync(path.join(target, 'docProps'))) {
        fs.mkdirSync(path.join(target, 'docProps'), 0755, function(e) {
          if (!e || (e && e.code === 'EEXIST')) {
            return console.log(path + 'created');
          } else {
            return console.log(e);
      ...
      if (!fs.existsSync(path.join(target, 'xl'))) {
        fs.mkdirSync(path.join(target, 'xl'), 0755, function(e) {
          if (!e || (e && e.code === 'EEXIST')) {
            return console.log(path + 'created');
          } else {
            return console.log(e);
      ...
      fs.mkdirSync(path.join(target, path.join('xl', '_rels')), 0755, function(e) {
        if (!e || (e && e.code === 'EEXIST')) {
          return console.log(path + 'created');
        } else {
          return console.log(e);
      ...
      fs.mkdirSync(path.join(target, path.join('xl', 'worksheets')), 0755, function(e) {
        if (!e || (e && e.code === 'EEXIST')) {
          return console.log(path + 'created');
        } else {
          return console.log(e);
      ...
      /*return exec.exec('rmdir "' + target + '"', function(err) {
        console.log(err)
        return cb(err);
      });*/
    };
